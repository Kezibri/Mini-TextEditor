...
public class Fenetre extends JFrame implements MouseListener, KeyListener{
	public static final String TEXTE_REPLAY = " ⟲ ";
	public static final String TEXTE_SAVE_1	= " ► ";
	public static final String TEXTE_SAVE_2	= " ■ ";
	...
	private void ajoutElementsGraphiques(){
		...
		panelGlobal	.add(panelMenu, BorderLayout.SOUTH);
